...
namespace Server.Items
{
	...
	public class PMList
	{
		...
		public static readonly PMList[] UORLists		= new PMList[] { Trammel, Felucca, Ilshenar, Malas, Tokuno };
		public static readonly PMList[] UORListsYoung		= new PMList[] { Trammel, Felucca, Ilshenar, Malas, Tokuno };
		public static readonly PMList[] LBRLists		= new PMList[] { Trammel, Felucca, Ilshenar, Malas, Tokuno };
		public static readonly PMList[] LBRListsYoung		= new PMList[] { Trammel, Felucca, Ilshenar, Malas, Tokuno };
		public static readonly PMList[] AOSLists		= new PMList[] { Trammel, Felucca, Ilshenar, Malas, Tokuno };
		public static readonly PMList[] AOSListsYoung		= new PMList[] { Trammel, Felucca, Ilshenar, Malas, Tokuno };
		...
		public static readonly PMList[] RedLists		= new PMList[] { Trammel, Felucca, Ilshenar, Malas, Tokuno };
		public static readonly PMList[] SigilLists		= new PMList[] { Trammel, Felucca, Ilshenar, Malas, Tokuno };
	}
