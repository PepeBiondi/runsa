    ...
    public class GenTeleporter
    {
        ...
        public class TeleportersCreator
        {
            ...
            public void CreateTeleportersTrammel( Map map )
            {
                ...
                //SA
                //Fire Island to Underworld
                CreateTeleporter(4194, 3260, 5, 1128, 1214, 0, map, Map.TerMur, true);
                CreateTeleporter(4195, 3260, 5, 1129, 1214, 0, map, Map.TerMur, true);
            }
            ...
            public int CreateTeleporters()
            {
                ...
                CreateTeleportersMap5(Map.TerMur);
                return m_Count;
            }
        }
    }
